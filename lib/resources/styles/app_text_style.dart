...
class AppTextStyle {
  ...
  static const TextStyle textStyleMediumGray2= TextStyle(
    color: AppColors.textAppGray,
    fontSize: 16,
    fontWeight: FontWeight.w500,
  );
  static const TextStyle textStyleMediumWhite = TextStyle(
    color: AppColors.white,
    fontSize: 18,
    fontWeight: FontWeight.w500,
  );
  static const TextStyle textStyleMediumBlack2 = TextStyle(
 ...
 static const TextStyle textStylePrimaryColorSemiBold2 = TextStyle(
    color: AppColors.primaryL,
    fontSize: 18,
    fontWeight: FontWeight.w600,
  );
  ...
  static const TextStyle textStyleBoldBlackonboard = TextStyle(
    color: AppColors.textBlack,
    fontSize: 18,
  ...
  static const TextStyle textStylegoldRegular33 = TextStyle(
    color: AppColors.secondaryL,
    fontSize: 33,
    fontWeight: FontWeight.w400,
  );
  static const TextStyle textStyleWhiteRegular13 = TextStyle(
    color: AppColors.textWhite,
    fontSize: 13,
    fontWeight: FontWeight.w400,
  );
  static const TextStyle textStyleWhiteRegular16 = TextStyle(
    color: AppColors.textWhite,
    fontSize: 16,
    fontWeight: FontWeight.w400,
  );
  ...
  static const TextStyle textStyleButton2 = TextStyle(
